...
public class EmailFragment extends Fragment implements  View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        gg = (RadioGroup)view.findViewById(R.id.RG);
    ...
    public void onClick(View view) {
        ...
        if(gg.getCheckedRadioButtonId()==R.id.r1)
        {
        ...
        else if(gg.getCheckedRadioButtonId()==R.id.r2)
        {
            String ee = E1.getText().toString();
            String bb = E2.getText().toString();
            String[] eee = ee.split("\n");
            Intent i1 = new Intent(Intent.ACTION_SENDTO);
            i1.setData(Uri.parse("mailto:" + eee[0]));
            i1.putExtra(Intent.EXTRA_BCC, eee);
            i1.putExtra(Intent.EXTRA_TEXT, bb);
            startActivity(i1);
        }
